...
let scnya = `⟥⟞⟚━┈┈ ❨ Hʏ ${tag} ❩ ┈┈━⟚⟝⟤`
    let footerny = `┆📮 *ɴᴏᴛᴇ!* : Chat ke owner jika ingin source code ini yang sudah dimodifikasi sebaik mungkin.\n┆🪀  *WhatsAPP* : https://github.com/ImYanXiao/Elaina-MultiDevice\n┆🥊 *Sᴄʀɪᴘᴛ* : ${snh}\n\n\n${readMore}┆ *I Love You:v*`
